...
import byte_verse from '../Assets/byte_verse.png'
import portfolio_img from '../Assets/portfolio.png'

const Projects = () => {
    const myproj = [
        {
            url: 'https://resume-builder-web-app.s3.amazonaws.com/index.html',
            image: projimg1,
            title: "ResumeCraft",
        ...
        {
            url: 'https://byte-verse.s3.amazonaws.com/pages/index.html',
            image: byte_verse,
            title: "ByteVerse",
            description: 'ByteVerse is a blog website which covers the blog related to technews , gadgets and many more',
        },
        {
