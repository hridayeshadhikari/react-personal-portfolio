  ...
  const edu = [
    {
      ...
      year: 2017,
      title: 'High school',
      description: 'I have completed my 10th from Doon Modern Academy Sr. Sec. School',
    ...
    },
    {
      ...
      year: 2019,
      title: 'Intermediate',
      description: 'I have completed my 12th from Doon Modern Academy Sr. Sec. School',
      style: 'shadow-blue-500',
      icon : <FontAwesomeIcon icon={faSchool} style={{color: "#8004b9",}} />,
    },
    {
    ...
    },
    {
      ...
      year: 2023,
      title: 'MCA',
      description: 'At present I am pursuing my post graduation in MCA from Amrapali Institute of Technology and Science Haldwani',
      style: 'shadow-blue-500',
      icon : <FontAwesomeIcon icon={faGraduationCap} style={{color: "#8004b9",}} />,
    },
  ];
